...
Project wiki for the active prototype `critter-corral`.

## Concept

A loop sort-puzzle where you herd living colored critters into matching pens by influence (lures, scares, gusts) instead of placing them; primitives first, art skinned later.
