...
- `gamedesing/` is a legacy path in this testbed. Do not rename it unless
  explicitly requested; new portable projects should use `gamedesign/`.
- The current active test concept is `gamedesing/fantasy-pocket-rpg/`.
- In this testbed, reusable design knowledge lives in `gamedesing/knowledge/`;
  portable export maps it to `gamedesign/knowledge/` for new projects.
