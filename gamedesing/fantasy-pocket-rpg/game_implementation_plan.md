...
6. `gamedesing/fantasy-pocket-rpg/data/asset_manifest.json`
...
Must implement: visible resources/stats, main click path, blocked/safe camp state, first upgrade, next-node unlock, screenshot/input validation.
