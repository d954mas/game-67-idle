...
const COPY = [
  ...
  "tools/assets/audit_project_asset_boundaries.mjs",
  ...
  "tools/assets/build_runtime_assets_from_crop_plan_test.py",
  ...
  "tools/assets/dual_plate_pair_gate.py",
  "tools/assets/dual_plate_pair_gate_test.py",
  "tools/assets/key_matte.py",
  "tools/assets/key_matte_test.py",
