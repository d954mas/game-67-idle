...
const exactToolNotes = new Map([
  ["ai_studio/core_harness/validation/pipeline_validate.mjs", "Validation orchestrator for reusable pipeline checks, review/full modes, export checks, docs, skills, and gates."],
