...
function usage() {
  console.error(`usage:
  node tools/assets/job/audit_project_asset_boundaries.mjs --name <boundary> --file <path> [--file <path> ...] --forbidden-pattern <regex> [--forbidden-pattern <regex> ...] [--json-output <path>]
