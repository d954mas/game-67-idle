...
CROPS: list[dict[str, Any]] = [
    {
        ...
        "target_preview_sizes": [[128, 48], [160, 52], [203, 64]],
        "stretch_policy": BUTTON_STRETCH,
        "usage_policy": {"size_class": "compact_only", "min_size": [128, 48], "disallowed_uses": ["large_primary_button"]},
    ...
    },
    {
        ...
        "target_preview_sizes": [[180, 56], [220, 60], [290, 64]],
        "stretch_policy": BUTTON_STRETCH,
        "usage_policy": {"size_class": "compact_only", "min_size": [180, 56], "disallowed_uses": ["large_primary_button"]},
    ...
    },
    {
        ...
        "target_preview_sizes": [[240, 64], [320, 64], [436, 72]],
        "stretch_policy": BUTTON_STRETCH,
        "usage_policy": {"size_class": "compact_only", "min_size": [240, 64], "disallowed_uses": ["large_primary_button"]},
    ...
    },
    {
        ...
        "target_preview_sizes": [[240, 64], [320, 64], [437, 72]],
        "stretch_policy": BUTTON_STRETCH,
        "usage_policy": {"size_class": "compact_only", "min_size": [240, 64], "disallowed_uses": ["large_primary_button"]},
...
def make_slice_preview(outputs_by_id: dict[str, Image.Image]) -> Image.Image:
    preview_specs = [
        ("compact_button_idle_short_v5", (128, 48)),
        ("compact_button_idle_medium_v5", (180, 56)),
        ("compact_button_idle_long_v5", (240, 64)),
        ("compact_button_disabled_short_v5", (128, 48)),
        ("compact_button_disabled_medium_v5", (180, 56)),
        ("compact_button_disabled_long_v5", (240, 64)),
