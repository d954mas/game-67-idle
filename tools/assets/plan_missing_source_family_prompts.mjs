...
function usage() {
  console.log(`usage:
  node tools/assets/plan_missing_source_family_prompts.mjs --job <art-job.json> [--coverage-audit <audit.json>] --output-dir <dir> [--key-color #00ff00] [--force]
