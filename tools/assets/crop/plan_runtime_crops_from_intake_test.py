...
SCRIPT = ROOT / "tools/assets/crop/plan_runtime_crops_from_intake.py"
...
class PlanRuntimeCropsFromIntakeTest(unittest.TestCase):
    def test_writes_named_row_major_crop_plan_with_clamped_padding(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(plan["schema"], "game.runtime_crop_plan")
