...
9. Validate on the native PC build first: `cmake --build --preset game-native-debug`, then relevant `tools/devapi/scenarios/*` scripts. Use WASM only when the user asks or the task targets web behavior.
