...
//   node .codex/skills/nt-app-tunnel/scripts/serve_tunnel.mjs --dir <wasm-build-dir> --port 8910
//
...
import { mimeType } from "../../../../ai_studio/core_harness/tool_lib/mime.mjs";
...
async function ensureCloudflared(binArg) {
  ...
  const binDir = resolve("tmp", "nt-app-tunnel", "bin");
