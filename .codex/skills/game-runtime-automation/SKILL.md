...
12. Do not enable automation in release builds unless explicitly requested by project policy.
13. Validate with native desktop/PC builds first. Run WASM/web checks only when explicitly requested or when the task targets web behavior.
