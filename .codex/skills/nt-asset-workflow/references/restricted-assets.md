...
`ai_studio/assets/storage/license/`.
...
```powershell
node ai_studio/assets/storage/intake/stage.mjs --manual --input "<local-file>" --source <source> --slug <slug> --license "<license>" --source-page-url <page-url> --publish false --source-root <asset-source>
```
