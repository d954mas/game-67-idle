...
- [ ] `gamedesign/projects/cozy-automation/gdd.md` names the first playable loop and player-readable goal.
- [ ] `gamedesign/projects/cozy-automation/data/core_loop.json` describes the
      ...
      reset-meta loops.
- [ ] `gamedesign/projects/cozy-automation/visual/live_state_acceptance_matrix.json`
