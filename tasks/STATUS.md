...
`T0034` / `T0035` / `T0036` / `T0037` are in review after asset-first
Roblox-like visual passes.
...
1. Review `T0037`, then continue asset-first visual work: animated mech source,
...
3. Keep latest product evidence in
   `gamedesign/projects/mech-builder-battler/evidence/t0037_station_plastic_world_composition_2026-06-20.md`.
