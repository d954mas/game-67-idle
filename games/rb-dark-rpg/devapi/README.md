...
Run after building a native Debug game:

```powershell
py -3.12 games/rb-dark-rpg/devapi/smoke_bot.py --exe games/rb-dark-rpg/build/native-debug/bin/game.exe
```
...
```powershell
cmake --build games/rb-dark-rpg/build/native-debug --target devapi_smoke
```
...
```powershell
cmake --build games/rb-dark-rpg/build/native-debug --target quality_responsive
```
...
```powershell
py -3.12 games/rb-dark-rpg/devapi/responsive_viewports.py `
  --exe games/rb-dark-rpg/build/native-debug/bin/game.exe `
  --scenario games/rb-dark-rpg/devapi/scenarios.py:prepare_upgrade_menu
```
...
```powershell
py -3.12 -m pytest games/rb-dark-rpg/devapi
```
