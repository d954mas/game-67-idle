...
- Design: `design/concept.md`, `design/gdd.md`
- First playable: Dress Room (layer outfit slots, catalog, random/reset)
- Platform: browser WASM primary; native debug for engine validation

Template shell layout below still describes the starter code until the dress-up
systems replace the demo cubes / resource HUD.

Spec + reuse model of the starter shell: `../../templates/TEMPLATE.md`.
