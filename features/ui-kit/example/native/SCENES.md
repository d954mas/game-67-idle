...
| `UI_KIT_BUTTON_CONFIRM` | green (`go`) | yes, the main action, a purchase for coins with the price and the coin on the button | УЛУЧШИТЬ, the upgrade prices, ПРОДОЛЖИТЬ |
