...
set(GAME_PUBLISH_TARGET "local" CACHE STRING "Publish target: local, itch, poki, yandex, playgama, or crazygames.")
...
set_property(CACHE GAME_PUBLISH_TARGET PROPERTY STRINGS local itch poki yandex playgama crazygames)
if(NOT GAME_PUBLISH_TARGET MATCHES "^(local|itch|poki|yandex|playgama|crazygames)$")
    message(FATAL_ERROR "GAME_PUBLISH_TARGET must be one of: local, itch, poki, yandex, playgama, crazygames")
endif()
...
elseif(GAME_PUBLISH_TARGET STREQUAL "playgama")
    ...
    set(GAME_PLATFORM_REWARDED_SUPPORTED 1)
    set(GAME_PLATFORM_STORAGE_SUPPORTED 1)
elseif(GAME_PUBLISH_TARGET STREQUAL "crazygames")
    # The portal allows community links on menus only, which the single
    # capability flag cannot express, so a game shows none.
    set(GAME_PLATFORM_SDK "crazygames")
    set(GAME_PLATFORM_TARGET_ID 5)
    set(GAME_PLATFORM_SDK_ID 4)
    set(GAME_PLATFORM_EXTERNAL_LINKS_ALLOWED 0)
    set(GAME_PLATFORM_ADS_SUPPORTED 1)
    set(GAME_PLATFORM_REWARDED_SUPPORTED 1)
    set(GAME_PLATFORM_STORAGE_SUPPORTED 1)
