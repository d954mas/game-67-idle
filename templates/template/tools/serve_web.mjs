...
//
//   node tools/serve_web.mjs [--preset wasm-release|wasm-debug|wasm-devapi-debug] [--target local|itch|poki|yandex|playgama|crazygames|wavedash|pikabu] [--port N] [--dir <bin>]
//
...
function main() {
  ...
  if (!["local", "itch", "poki", "yandex", "playgama", "crazygames", "wavedash", "pikabu"].includes(a.target)) {
