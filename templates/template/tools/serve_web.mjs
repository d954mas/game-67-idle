...
//
//   node tools/serve_web.mjs [--preset wasm-release|wasm-debug|wasm-devapi-debug] [--target local|itch|poki|yandex|playgama|crazygames|wavedash] [--port N] [--dir <bin>]
//
...
function main() {
  ...
  if (!["local", "itch", "poki", "yandex", "playgama", "crazygames", "wavedash"].includes(a.target)) {
