...
test("canonical target descriptors expose every target and its SDK mapping", () => {
  assert.deepEqual(targetNames(), ["local", "itch", "poki", "yandex", "playgama", "crazygames", "wavedash", "pikabu", "gamepush"]);
  assert.deepEqual(portalTargetNames(), ["itch", "poki", "yandex", "playgama", "crazygames", "wavedash", "pikabu", "gamepush"]);
