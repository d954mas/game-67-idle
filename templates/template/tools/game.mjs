...
const USAGE = "usage: node tools/game.mjs <doctor|build|run|test|playable|package|portal-check|verify> [--target local|itch|poki|yandex|playgama|crazygames|wavedash] [--no-build] [--out <dir>] [--template-proof] [--skip-tests] [test: --tier core|slow|taste | --all | --only <test>] [--update-goldens]";
