...
static void asset_init(game_audio_asset_t *asset, nt_hash64_t id) {
...
bool game_audio_init(void) {
    ...
    s_mix_applied = false;
    asset_init(&s_ui_click, ASSET_BLOB_AUDIO_SFX_UI_CLICK);
    asset_init(&s_demo_jingle, ASSET_BLOB_AUDIO_MUSIC_DEMO_JINGLE);
