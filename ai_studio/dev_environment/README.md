...
These files are tracked parent-Studio outputs. They are generated from scanned
public folders only and must not include private ids, paths, or remotes. Private
game IDE entries belong inside the private game repository or
...
This resolves `game:<game-id>` under `games/private/`, runs the workspace
