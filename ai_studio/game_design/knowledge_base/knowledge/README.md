...
- `ai_studio/game_design/knowledge_base/knowledge/` - reusable principles, checklists, patterns, and
  reference-study methods that can apply across game projects.
- `ai_studio/game_design/knowledge_base/sources/` - optional raw source notes, excerpts, links, and
...
- Work status and deferred tasks belong in `ai_studio/taskboard/items/`, not here.
...
- Use `ai_studio/game_design/knowledge_base/sources/` for raw research; summarize only reusable lessons
  in `knowledge/`.
