...
captures, and excerpts that should not be mixed into polished knowledge pages.

Rules:

- Keep source notes factual and close to the original material.
- Put reusable conclusions in `ai_studio/game_design/knowledge_base/knowledge/` and link back here when
  the source matters.
