...
- 2026-07-15: Slice 4: runtime routes are now strict: stack add/remove/count/can_afford reject unique defs, instance create/destroy reject stack defs, and finite stack caps clamp accepted additions while full or legacy over-cap adds fail without mutation. Stack moves conserve totals. Independent review ACCEPT.
- 2026-07-15: Quality: QTECH_001=pass; evidence: rebuilt native test_items_fragment 27/27, test_progression pass, test_template_composition pass; route/cap review ACCEPT.
- 2026-07-15: Slice 5: evaluator now deep-copies authentic studio.field i64 handles, registers/sorts field IDs, members, and kinds before definitions/refs, rejects sealed/duplicate/malformed identities at stable Lua sources, and includes schema rows in output budgets. Module order and same-extension conflicts are deterministic. Independent re-review ACCEPT after four findings were fixed.
- 2026-07-15: Quality: QTECH_001=pass; evidence: Lua sandbox 15/15, Snapshot 8/8, items_ops 22/22, typed API proof 19/19, feature contracts 6 modules/2 pointers, git diff check clean, schema registration review ACCEPT.
- 2026-07-15: Slice 6: levels.generate now materializes named formula columns with explicit max_level and overrides; every level 2+ requires paid/free cost_to_reach. Formula captures are limited to authentic immutable Studio APIs/item refs, capture reassignment and late registration fail, dynamic forged refs fail, raw Lua arithmetic/bitwise operators are gated, and formula/override integers stay in checked exact range. Independent review ACCEPT after math/override bypasses were fixed.
- 2026-07-15: Quality: QTECH_001=pass; evidence: generated formula review ACCEPT, Lua sandbox 15/15 including raw-math, unsafe literal/override, late registration, mutable capture, and forged-ref regressions; Snapshot 8/8; feature contracts 6 modules/2 pointers; git diff check clean.
- 2026-07-15: Slice 7: levels.columns now materializes bounded mixed series from authentic levels.linear/levels.values handles in stable column order, applies deterministic overrides, preserves nested ref/cost authenticity and sources, and reuses final exact-range/transition validation. Independent review ACCEPT; adversarial linear overflow and wrong-handle probes fail correctly.
- 2026-07-15: Quality: QTECH_001=pass; evidence: mixed-column review ACCEPT, Lua sandbox 16/16, Snapshot 8/8, feature contracts 6 modules/2 pointers, adversarial linear overflow/wrong handle/source probes pass, git diff check clean.
- 2026-07-15: Slice 8: the one items.lock receipt upgraded to v4/v2 with active/reserved field ID history. Frozen v2 locks upgrade directly with exact bytes; v3 receipts migrate existing field IDs to active; repeat runs are no-op. Template/new-game now use v4/v2 while new-game resets only per-game item history and preserves receipt metadata. Independent review ACCEPT after production new-game drift was fixed.
- 2026-07-15: Quality: QTECH_001=pass; evidence: receipt v4/new-game review ACCEPT, items_ops 23/23, new_game 47/47, template validation clean, feature contracts 6 modules/2 pointers, git diff check clean.
