...
- 2026-07-03: Landed + committed: visible flip toggles, +-90 steps, conditional reset, header transform badge, inspectorSig transform coverage. F5 only. Awaiting lead verify.
