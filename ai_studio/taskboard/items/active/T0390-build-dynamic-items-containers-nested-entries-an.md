...
- 2026-07-16: CI run 29535296562: Ubuntu passed; Windows reached the canonical capture output but the legacy test assertion still relativized it against the noncanonical RUNNER~1 spelling. Updated only the assertion to use project.resolve(); complete items_cli_test.py remains 24/24.
