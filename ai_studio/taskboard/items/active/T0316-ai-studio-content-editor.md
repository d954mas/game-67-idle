...
- Дата добавления предмета — из GIT-истории items.json (редактор
  дёргает git log), НЕ из данных: расширять lock метаданными добавления
  лид отказался (добавление неразрушительно, версия не двигается).
