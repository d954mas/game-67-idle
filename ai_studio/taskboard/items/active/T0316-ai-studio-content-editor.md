...
- 2026-07-08 (консервация, лид сворачивается по токенам): МИНИ-РАУНД
  ...
  атрибуцией (обязательство наследовалось бы каждой игрой-копией).
  Замена сета на CC0 У ИСПОЛНИТЕЛЯ (та же геометрия раунда: id/пути
  не меняются, PNG+README+перегенерация тест-фикстуры — старая
  содержит CC BY-пиксели, репо чистится целиком; если какая-то
  иконка не найдётся в CC0 — СТОП по ней, старый файл остаётся,
  вопрос вернётся лиду); (б) SVG-источник — РАТИФИЦИРОВАНО лидом 2026-07-08 («я в
