...
- 2026-07-04: Follow-up landed c9bc8186 (my review + suites 568/51/py15): magenta via hue180 shim (ck_pixel_ops.py numpy HSV port, drift<=2/255, alpha byte-exact; provenance shim:'hue180') + region-scoped CK (compose_regions reuses alpha_cutout region_mask bit-for-bit). Live smokes green 10.1s / magenta 13.1s, gold stays gold. corridorkey method COMPLETE: green native, magenta shimmed, regions, batch; neutral = loud refusal. T0261 fully done.
