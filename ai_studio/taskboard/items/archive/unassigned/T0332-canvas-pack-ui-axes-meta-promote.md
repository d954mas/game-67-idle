...
- [x] Лид: приёмка фичи в UI («апрув», 2026-07-07; включая agy-smoke — паки
      открыты на codex+gemini).
...
- 2026-07-07: Лид принял фичу (апрув 2026-07-07): все Done-when закрыты, включая agy-smoke (паки на codex+gemini, урок про линии в README/скилле). Закрыто.
