...
group: assets
description: Use when material-dependent assets can lose textures, UVs, colors, material maps, or material assignment during source intake, prep, conversion, or game-use-ready use.
---
...
stage: source intake, preparation/conversion, or game-use-ready use.

## Use When

Use when adding, accepting, preparing, converting, generating, or claiming
game-use-ready material-dependent models, textures, materials, props, surfaces,
...
- game-use path/format readiness without material-dependent visuals;
...
- prepared/converted stage preserves material files, UVs, and material
  assignment in the manifest or game-use-ready asset;
- game-use-ready stage has viewer, runtime, or screenshot proof that material
