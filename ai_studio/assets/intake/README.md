...
metadata that `../catalog/` can read.
...
```powershell
node ai_studio/assets/intake/stage.mjs --source-root <asset-source> --input <file-or-folder> --source <site-or-owner> --slug <candidate>
node ai_studio/assets/intake/accept.mjs --source-root <asset-source> --source <site-or-owner> --slug <candidate> --file <relative-file> --pack <pack-id> --asset-id <id> --kind <kind> --license <license>
node ai_studio/assets/intake/reject.mjs --source-root <asset-source> --source <site-or-owner> --slug <candidate>
```
