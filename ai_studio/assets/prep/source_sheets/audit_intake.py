...
from ai_studio.assets.prep.lib.atomic_io import write_json_atomic, write_text_atomic
from ai_studio.assets.prep.cutout.chroma_key_alpha import (
    key_fringe_mask_rgb,
...
def component_pixels_from_private_runs(array: object, component: dict[str, object]) -> object | None:
...
def add_key_conflict_metrics(
    ...
    for component in components:
        ...
        component_pixels = component_pixels_from_private_runs(array, component)
