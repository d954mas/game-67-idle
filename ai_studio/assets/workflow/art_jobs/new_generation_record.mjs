...
function usage() {
  console.log(`usage:
  node ai_studio/assets/workflow/art_jobs/new_generation_record.mjs --id <record-id> --project-dir <project-dir> --source-family <family> --accepted-source <path> --provider <name> --model <name> (--seed <seed> | --no-seed-reason <text>) --prompt <text> --negative-prompt <text> [options]
