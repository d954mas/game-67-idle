# Backlog Asset Storage

Current storage layer for AI Studio asset sources.

This module is under `assets/backlog/` because it still mixes several concerns:
source registry helpers, intake, manifests, generated indexes, preview cache,
and license policy. Keep it functional, but do not treat the backlog placement
as the final architecture.

## Role

Backlog Asset Storage owns source registration, editable asset metadata, generated
