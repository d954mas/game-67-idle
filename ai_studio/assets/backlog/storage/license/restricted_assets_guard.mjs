...
function loadExceptionPrefixes(root) {
  const f = join(root, "ai_studio", "assets", "backlog", "storage", "license", "restricted_assets_exceptions.json");
...
export function main() {
  ...
  if (!ok) {
    ...
    console.error("\nfix: record the asset in a manifest with a publishable license, or move the binary under assets/restricted/ (gitignored) and re-pull. See ai_studio/assets/backlog/storage/license/restricted.mjs.");
    process.exit(1);
  }
  if (warnings.length) {
