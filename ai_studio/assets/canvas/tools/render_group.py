...
# T0274: apply_filters extracted to its own module so render_group.py (live render/export)
# and bake_filters.py (T0274 "Apply" — burns filters+opacity into a NEW source file) share
# ONE implementation of the canonical brightness/saturate/contrast/tint chain — see
# filters_math.py's module docstring and README "Image filters".
