> Archived deep reference. Relative links in this file are rebased to the Canvas module directory (the original file base was `ai_studio/assets/canvas/`). For current routing, start at [the Canvas README](../README.md).
